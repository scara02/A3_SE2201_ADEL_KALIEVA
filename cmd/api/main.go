...
import (
	...
	"github.com/scara02/A3_SE2201_ADEL_KALIEVA/internal/data"
	"github.com/scara02/A3_SE2201_ADEL_KALIEVA/internal/jsonlog"
	"github.com/scara02/A3_SE2201_ADEL_KALIEVA/internal/mailer"
	"github.com/scara02/A3_SE2201_ADEL_KALIEVA/internal/vcs"
...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "4806f27a5456be", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "70bb23a97c614a", "SMTP password")
